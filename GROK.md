...
1. Vymeň celý `vulcanus-shop-demo/bulk-paleta/` (zoznam v `HOTOVO.md`). Plugin 2.2.2.
...
5. Over `/paliva/`, `/objednavka-paleta/`, `/ako-to-predavame/` — musia vyzerať ako náhľad: tri dlaždice v hlavičke + na Palete celý konfigurátor (rebrík, meter, živý €/kg).
